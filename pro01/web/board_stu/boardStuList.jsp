...
<%
    if(sid != null && (sjob.equals("1") || sid.equals("admin"))) {
        ...
        out.println("<script>alert('해당 페이지는 학생만 접근 가능합니다.')</script>");
...
<%
    ...
    // 해당 회원의 정보를 db에서 가져옴
    try {
        String sql = "select * from board_stu where lev=0 order by par desc";
    ...
    <div class="contents" id="contents">
        ...
        <section class="page" id="page1">
            <div class="page_wrap">
                ...
                <div class="btn_group">
                    <% if (sid != null) { %>
                    <a href="addBoardStu.jsp" class="inbtn"> 글 작성 </a>
                    <% } else {%>
                    <p>글을 쓰려면 로그인 하세요</p>
                    <% } %>
                </div>
