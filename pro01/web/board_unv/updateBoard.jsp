...
<%
    ...
    try{
        String sql = "select * from board_unv where bno=?";
                    ...
                    <form action="updateBoardpro.jsp" id="login_frm" class="frm">
                        <table class="tb1">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="2"><input type="text" name="hl" id="hl" class="indata" value="<%=q.getLink()%>" placeholder="링크 입력" autofocus required></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
